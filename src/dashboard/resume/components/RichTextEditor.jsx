...
function RichTextEditor({onRichTextEditorChange,index,defaultValue}) {
    ...
    const GenerateSummaryFromAI = async () => {
      ...
      // Mock AI response
      const mockResponse = `<ul>
        <li>Developed and maintained full-stack applications using modern technologies</li>
        <li>Collaborated with cross-functional teams to deliver high-quality software solutions</li>
        <li>Implemented responsive user interfaces ensuring optimal user experience</li>
        <li>Participated in code reviews and mentored junior developers</li>
        <li>Optimized application performance and resolved complex technical issues</li>
      </ul>`;
      setTimeout(() => {
